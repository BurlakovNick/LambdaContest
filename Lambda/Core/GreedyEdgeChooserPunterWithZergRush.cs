...
namespace Core
{
    public class GreedyEdgeChooserPunterWithZergRush : IPunter
    {
        private readonly IScorer scorer;
        private readonly IGraphVisitor graphVisitor;

        public GreedyEdgeChooserPunterWithZergRush(
            IScorer scorer,
        ...
        public Edge Claim(GameState gameState)
        {
            ...
            var bestRushingPathEdge = map
                ...
                .Where(x => x.Punter == null && !HasNeighborPunterEdge(map, x, punter))
